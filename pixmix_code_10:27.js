$(document).ready(function() {
    ...
    Display.prototype.toggleSidebarEdit = function(showHide, photoInfo, mode) {
        ...
        if (showHide == "hide") {
            ...
            $("#photo-edit").off("click");
            $("#photo-edit").on("click", null, function(){
                console.log("-- editSavePhoto");
                displayObject.toggleSidebarEdit("show", null, "edit");
    ...
    Display.prototype.editCurrentPhoto = function() {
        ...
        this.showSelectedPhoto(null, "edit");
    }
    ...
    // ======= ======= ======= updateMode ======= ======= =======
    Menu.prototype.updateMode = function(whichMode) {
    ...
    Menu.prototype.activateMenuTagEventListener = function(whichLink, whichMenuCategory) {
        ...
        $(whichLink).on("click", function(){
            ...
            // == change tag link to selected value
            switch(whichMenuCategory) {
                case "genre":
    ...
    Menu.prototype.getUserPhotos = function() {
        ...
        $.ajax({
            ...
            displayObject.toggleSidebarInfo("hide", null, "show");
    ...
    Menu.prototype.getThumbnailPhoto = function(whichThumbnail) {
        ...
        $.ajax({
            ...
            displayObject.showSelectedPhoto(jsonData, "show");
            displayObject.toggleSidebarInfo("show", jsonData, "show");
            displayObject.toggleSidebarEdit("show", jsonData, "show");
        }).fail(function(){
            console.log("*** ajax fail T ***");
        });
    }
    ...
    menuObject.updateMode(gon.mode);
